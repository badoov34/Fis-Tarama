/**
 * Manuel Gider Ekleme — Fotoğraf olmadan doğrudan giriş.
 * Çoklu KDV satırı desteği + fiş/belge numarası.
 */
...
export default function ManualAddScreen({ navigation }) {
  ...
  const [vatLines, setVatLines] = useState([
    { vat_rate: 20, total_amount: "", net_amount: "", vat_amount: "" },
  ]);
  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scroll}>
        <Text style={styles.title}>✏️ Manuel Gider Ekle</Text>
